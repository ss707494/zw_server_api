...
const ProductItemOneRow = ({
  ...
  return __jsx(RowBox, {
    ...
    alt: ""
  })), __jsx(LeftBox, null, __jsx("main", null, product.name, " ", product.weight, product.unit, " ", product.packingUnitString), showSumOrder && __jsx(Tip, null, sumOrderTip, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_15__[/* ls */ "a"])('销量'), ": ", product.sumOrder), __jsx(Price, null, __jsx(ProductPrice, {
    product: product
