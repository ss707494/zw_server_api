  ...
  return __jsx("div", null, __jsx(_components_HeaderTitle_HeaderTitle__WEBPACK_IMPORTED_MODULE_2__[/* HeaderTitle */ "a"], {
    ...
    onClick: async () => {
      ...
      if (!stateShopCartModel.form.addressId || !addressData.city) {
        Object(_components_Message_Message__WEBPACK_IMPORTED_MODULE_18__[/* showMessage */ "b"])(Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_6__[/* ls */ "a"])('请选择送货地址'));
        return;
      }

      if (!cardData.number) {
        Object(_components_Message_Message__WEBPACK_IMPORTED_MODULE_18__[/* showMessage */ "b"])(Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_6__[/* ls */ "a"])('请选择信用卡'));
        return;
      }
...
})(["display:flex;flex-direction:column;flex-grow:1;> main{line-height:22px;", ";}"], _style_common__WEBPACK_IMPORTED_MODULE_9__[/* mpStyle */ "b"].ellipsis);
...
const ProductItemOneRow = ({
  ...
  return __jsx(RowBox, {
    ...
    alt: ""
  })), __jsx(LeftBox, null, __jsx("main", null, product.name, " ", product.weight, product.unit, " ", product.packingUnitString, console.log(product)), showSumOrder && __jsx(Tip, null, sumOrderTip, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_15__[/* ls */ "a"])('销量'), ": ", product.sumOrder), __jsx(Price, null, __jsx(ProductPrice, {
    product: product
...
function Me() {
  ...
  }, me_jsx(Header, null, me_jsx("header", null, Object(dealKey["a" /* ls */])('您好,'), (_stateMeModel$user$us = stateMeModel.user.userInfo) === null || _stateMeModel$user$us === void 0 ? void 0 : _stateMeModel$user$us.name), me_jsx(ShopIcon, null, me_jsx(ShoppingCartIconButton["a" /* ShoppingCartIconButton */], {
    htmlColor: 'white'
  })), me_jsx("section", null, (_stateMeModel$user$us2 = stateMeModel.user.userInfo) === null || _stateMeModel$user$us2 === void 0 ? void 0 : _stateMeModel$user$us2.phone), me_jsx("section", null, (_stateMeModel$user$us3 = stateMeModel.user.userInfo) === null || _stateMeModel$user$us3 === void 0 ? void 0 : _stateMeModel$user$us3.email), me_jsx("aside", null, me_jsx(core_["Button"], {
    color: 'inherit',
    variant: 'outlined',
  ...
  }, me_jsx(MonetizationOn_default.a, null), me_jsx("main", null, (_stateMeModel$user$or = stateMeModel.user.orderCoinCurrentMonth) !== null && _stateMeModel$user$or !== void 0 ? _stateMeModel$user$or : 0), me_jsx("footer", null, Object(dealKey["a" /* ls */])('本月可用达人币'))), me_jsx(Parting, null), me_jsx(Card, {
    onClick: () => {
      actionsCoinDetailDialogModel.openClick(_objectSpread(_objectSpread({}, stateMeModel.user), {}, {
        isNextMonth: true
      }));
    }
  }, me_jsx(MonetizationOn_default.a, null), me_jsx("main", null, (_stateMeModel$user$or2 = stateMeModel.user.orderCoinNextMonth) !== null && _stateMeModel$user$or2 !== void 0 ? _stateMeModel$user$or2 : 0), me_jsx("footer", null, Object(dealKey["a" /* ls */])('下月积攒达人币'))), me_jsx(Parting, null), me_jsx(Card, {
    onClick: () => {
