...
const CoinDetailDialog = () => {
  ...
  }, __jsx(core_["DialogContent"], null, stateCoinDetailDialogModel.dialogData.isNextMonth && __jsx(ItemBox, null, __jsx("aside", null, Object(dealKey["a" /* ll */])('本月消费积攒')), __jsx("main", null, stateCoinDetailDialogModel.dialogData.orderCoinCurrentMonth)), !stateCoinDetailDialogModel.dialogData.isNextMonth && __jsx(external_react_default.a.Fragment, null, __jsx(ItemBox, null, __jsx("aside", null, Object(dealKey["a" /* ll */])('上月消费积攒')), __jsx("main", null, stateCoinDetailDialogModel.dialogData.orderCoinLastMonthGet)), __jsx(ItemBox, null, __jsx("aside", null, Object(dealKey["a" /* ll */])('本月消费抵扣')), __jsx("main", null, stateCoinDetailDialogModel.dialogData.orderCoinCurrentMonthCost)), __jsx(ItemBox, null, __jsx("aside", null, Object(dealKey["a" /* ll */])('本月可用余额')), __jsx("main", null, stateCoinDetailDialogModel.dialogData.orderCoinCurrentMonth)))));
};
...
function Me() {
  ...
  }, me_jsx(Header, null, me_jsx("header", null, Object(dealKey["a" /* ll */])('您好,'), (_stateMeModel$user$us = stateMeModel.user.userInfo) === null || _stateMeModel$user$us === void 0 ? void 0 : _stateMeModel$user$us.name), me_jsx(ShopIcon, null, me_jsx(ShoppingCartIconButton["a" /* ShoppingCartIconButton */], {
    htmlColor: 'white'
  ...
  }, Object(dealKey["a" /* ll */])('登出')))), me_jsx(Tab, null, me_jsx(Card, {
    onClick: () => {
      actionsCoinDetailDialogModel.openClick(_objectSpread(_objectSpread({}, stateMeModel.user), {}, {
        isNextMonth: false
      }));
    }
  }, me_jsx(MonetizationOn_default.a, null), me_jsx("main", null, (_stateMeModel$user$or = stateMeModel.user.orderCoinCurrentMonth) !== null && _stateMeModel$user$or !== void 0 ? _stateMeModel$user$or : 0), me_jsx("footer", null, Object(dealKey["a" /* ll */])('本月可用达人币'))), me_jsx(Parting, null), me_jsx(Card, {
    onClick: () => {
      actionsCoinDetailDialogModel.openClick(_objectSpread(_objectSpread({}, stateMeModel.user), {}, {
        isNextMonth: true
      }));
    }
  }, me_jsx(MonetizationOn_default.a, null), me_jsx("main", null, (_stateMeModel$user$or2 = stateMeModel.user.orderCoinNextMonth) !== null && _stateMeModel$user$or2 !== void 0 ? _stateMeModel$user$or2 : 0), me_jsx("footer", null, Object(dealKey["a" /* ll */])('下月积攒达人币'))), me_jsx(Parting, null), me_jsx(Card, {
    onClick: () => {
      router.push('/m/card/DarenCard');
    }
  }, me_jsx(Payment_default.a, null), me_jsx("main", null, stateCardModel.promoCodeList.filter(v => v.promoCodeType === ss_common_enum["j" /* PromoCodeTypeEnum */].DarenCard).length), me_jsx("footer", null, Object(dealKey["a" /* ll */])('达人卡')))), me_jsx(ListItem, {
    onClick: () => {
      router.push('/m/me/orderHistory');
    }
  }, me_jsx(History_default.a, null), me_jsx("main", null, me_jsx("section", null, Object(dealKey["a" /* ll */])('我的订单历史'))), me_jsx("aside", null, me_jsx(ArrowForwardIos_default.a, null))), me_jsx(ListItem, {
    onClick: () => {
      router.push('/m/me/myInfo');
    }
  }, me_jsx(CardMembership_default.a, null), me_jsx("main", null, me_jsx("section", null, Object(dealKey["a" /* ll */])('我的达人证'))), me_jsx("aside", null, me_jsx(ArrowForwardIos_default.a, null))), me_jsx(ListItem, {
    onClick: () => {
      router.push('/m/me/myCreditCard');
    }
  }, me_jsx(CardGiftcard_default.a, null), me_jsx("main", null, me_jsx("section", null, Object(dealKey["a" /* ll */])('我的信用卡'))), me_jsx("aside", null, me_jsx(ArrowForwardIos_default.a, null))), me_jsx(ListItem, {
    onClick: () => {
      router.push('/m/me/pickupAddress');
    }
  }, me_jsx(PinDrop_default.a, null), me_jsx("main", null, me_jsx("section", null, Object(dealKey["a" /* ll */])('我的取货点'))), me_jsx("aside", null, me_jsx(ArrowForwardIos_default.a, null))), me_jsx(ListItem, {
    onClick: () => {
      router.push('/m/me/myAddress');
    }
  }, me_jsx(PersonPinCircle_default.a, null), me_jsx("main", null, me_jsx("section", null, Object(dealKey["a" /* ll */])('我的地址'))), me_jsx("aside", null, me_jsx(ArrowForwardIos_default.a, null))), me_jsx(ListItem, {
    onClick: () => {
      router.push('/m/me/helpCenter');
    }
  }, me_jsx(HelpOutline_default.a, null), me_jsx("main", null, me_jsx("section", null, Object(dealKey["a" /* ll */])('帮助中心'))), me_jsx("aside", null, me_jsx(ArrowForwardIos_default.a, null))), me_jsx("section", {
    style: {
      height: '200px',
      width: '2px'
    }
...
const getPromoCodeItem = (item, user) => {
  return item.promoCodeType === _ss_common_enum__WEBPACK_IMPORTED_MODULE_7__[/* PromoCodeTypeEnum */ "j"].DarenCard ? __jsx(CardBox, {
    ...
    alt: ""
  })), __jsx(Title, null, item.title), __jsx(Remark, null, item.remark), __jsx(CodeBox, null, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_3__[/* ll */ "a"])('优惠码'), ": ", item.code), __jsx(Time, null, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_3__[/* ll */ "a"])('使用时间'), ": ", Object(_tools_utils__WEBPACK_IMPORTED_MODULE_10__[/* formatDate */ "e"])(item.effectiveDateStart, 'YYYY/MM/dd'), " - ", Object(_tools_utils__WEBPACK_IMPORTED_MODULE_10__[/* formatDate */ "e"])(item.effectiveDateEnd, 'YYYY/MM/dd')), __jsx(Action, null, __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_5__["Button"], {
    color: 'secondary',
    variant: 'contained',
    fullWidth: true,
    onClick: () => {
  ...
  }, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_3__[/* ll */ "a"])('应用到购物车')))) : __jsx(CardBoxPromoCode, {
    ...
    h: 8
  }), __jsx(Time, null, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_3__[/* ll */ "a"])('使用时间'), ": ", Object(_tools_utils__WEBPACK_IMPORTED_MODULE_10__[/* formatDate */ "e"])(item.effectiveDateStart, 'YYYY/MM/dd'), " - ", Object(_tools_utils__WEBPACK_IMPORTED_MODULE_10__[/* formatDate */ "e"])(item.effectiveDateEnd, 'YYYY/MM/dd')), __jsx(_components_Box_Box__WEBPACK_IMPORTED_MODULE_15__[/* Space */ "b"], {
    h: 8
  }), __jsx(CodeBox, null, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_3__[/* ll */ "a"])('优惠码'), ": ", item.code), __jsx(_components_Box_Box__WEBPACK_IMPORTED_MODULE_15__[/* Space */ "b"], {
    h: 8
  ...
  }, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_3__[/* ll */ "a"])('应用到购物车'))));
};
const CardType = () => {
  ...
  return __jsx("div", null, __jsx(_components_HeaderTitle_HeaderTitle__WEBPACK_IMPORTED_MODULE_2__[/* HeaderTitle */ "a"], {
    title: Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_3__[/* ll */ "a"])('达人专区'),
    showCart: true,
    hideLeft: true,
    showSearch: true
    ...
    label: Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_3__[/* ll */ "a"])('我的达人卡')
  }), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_5__["Tab"], {
    value: _ss_common_enum__WEBPACK_IMPORTED_MODULE_7__[/* PromoCodeTypeEnum */ "j"].PromoCode,
    label: Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_3__[/* ll */ "a"])('当前优惠促销')
