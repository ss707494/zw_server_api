...
const OrderPage = () => {
  ...
  const transportationCosts = stateSCM.form.pickUpType === _ss_common_enum__WEBPACK_IMPORTED_MODULE_7__[/* PickUpTypeEnum */ "f"].Delivery && stateSCM.freightConfig.reduce((pre, cur) => {
...
const ShopCartPage = () => {
  ...
  return __jsx("div", null, __jsx(HeaderTitle["a" /* HeaderTitle */], {
    title: '购物车'
  }), !!getLoad(doc["b" /* doc */].userShopCartList) && __jsx(core_["LinearProgress"], null) || __jsx("div", {
    style: {
      height: '4px'
    }
