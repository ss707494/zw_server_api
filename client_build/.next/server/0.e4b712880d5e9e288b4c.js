...
const GroupProductItem = ({
  ...
  return __jsx(GroupBox, {
    ...
    alt: ""
  })), __jsx(RightBox, null, __jsx(Title, null, product.name, "(", product.groupRemark, "/", product.groupAmount, product.groupAmountUnitString, "/", product.groupPrecisionString, ")", (groupQueue === null || groupQueue === void 0 ? void 0 : groupQueue.id) && __jsx(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment, null, [...Array(product.groupPrecision)].map((v, i) => i).map(value => {
