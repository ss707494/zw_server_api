...
const CoinDetailDialog = () => {
  ...
  }, __jsx(core_["DialogContent"], null, __jsx(ItemBox, null, __jsx("aside", null, Object(dealKey["a" /* ls */])('上月消费积攒')), __jsx("main", null, stateCoinDetailDialogModel.dialogData.orderCoinLastMonthGet)), __jsx(ItemBox, null, __jsx("aside", null, Object(dealKey["a" /* ls */])('本月消费抵扣')), __jsx("main", null, stateCoinDetailDialogModel.dialogData.orderCoinCurrentMonthCost)), __jsx(ItemBox, null, __jsx("aside", null, Object(dealKey["a" /* ls */])('本月可用余额')), __jsx("main", null, stateCoinDetailDialogModel.dialogData.orderCoinCurrentMonth))));
};
...
function Me() {
  ...
  }, me_jsx(MonetizationOn_default.a, null), me_jsx("main", null, (_stateMe$user$orderCo = stateMe.user.orderCoinCurrentMonth) !== null && _stateMe$user$orderCo !== void 0 ? _stateMe$user$orderCo : 0), me_jsx("footer", null, Object(dealKey["a" /* ls */])('本月可用达人币'))), me_jsx(Parting, null), me_jsx(Card, null, me_jsx(MonetizationOn_default.a, null), me_jsx("main", null, (_stateMe$user$orderCo2 = stateMe.user.orderCoinNextMonth) !== null && _stateMe$user$orderCo2 !== void 0 ? _stateMe$user$orderCo2 : 0), me_jsx("footer", null, Object(dealKey["a" /* ls */])('下月积攒达人币'))), me_jsx(Parting, null), me_jsx(Card, {
    onClick: () => {
