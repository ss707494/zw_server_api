...
module.exports = __webpack_require__("iGuI");
...
// CONCATENATED MODULE: ./utils/view/me/pickupAddress/list.tsx
var __jsx = external_react_default.a.createElement;
...
const pickupAddressModel = Object(modelUtil["c" /* modelFactory */])('pickupAddressModel', {
  list: [],
  user: {}
}, {
  getList: async (value, option) => {
    ...
    const res = await option.query(doc["b" /* doc */].pickupAddress, {});
    option.setData(Object(utils["f" /* fpMergePre */])({
  ...
  setDefault: async (value, option) => {
    ...
    const res = option.mutate(doc["b" /* doc */].updateUserInfo, {
      userInfo: {
...
const ItemBox = external_styled_components_default()(core_["ButtonBase"]).withConfig({
  displayName: "list__ItemBox",
  componentId: "gj9w8w-0"
})(["&&&{display:flex;padding:10px 20px;> img{width:18vw;height:18vw;}> section{margin-left:9px;text-align:left;> main,footer{font-size:12px;color:", ";}}}"], colors_["grey"][600]);
...
const PickupAddress = () => {
  const {
    actions: actionsPAM,
    state: statePAM
  } = Object(useStore["b" /* useStoreModel */])(pickupAddressModel);
  Object(external_react_["useEffect"])(() => {
  ...
  return __jsx("div", null, __jsx(HeaderTitle["a" /* HeaderTitle */], {
    title: '我的取货点'
  }), __jsx(Box, null, statePAM.list.map(value => {
    ...
    return __jsx(external_react_default.a.Fragment, {
      ...
      alt: ""
    }), __jsx("section", null, __jsx("header", null, value.fullName), __jsx("main", null, `${value.province} ${value.city}`), __jsx("footer", null, `${value.streetAddress}`))), ((_statePAM$user$userIn = statePAM.user.userInfo) === null || _statePAM$user$userIn === void 0 ? void 0 : _statePAM$user$userIn.pickupAddressId) === value.id && __jsx("section", null, Object(dealKey["a" /* ls */])('默认地址')) || __jsx(core_["Button"], {
      color: 'secondary',
      onClick: async () => {
    ...
    }, Object(dealKey["a" /* ls */])('设为默认')));
  })));
};
// CONCATENATED MODULE: ./pages/me/pickupAddress/index.tsx

/* harmony default export */ var pickupAddress = __webpack_exports__["default"] = (PickupAddress);
