...
module.exports = __webpack_require__("hgoI");
...
// EXTERNAL MODULE: external "@material-ui/icons/Streetview"
var Streetview_ = __webpack_require__("MX+i");
var Streetview_default = /*#__PURE__*/__webpack_require__.n(Streetview_);
...
// CONCATENATED MODULE: ./utils/view/me/myAddress/list.tsx
var __jsx = external_react_default.a.createElement;
...
const myAddressModel = Object(modelUtil["c" /* modelFactory */])('myAddressModel', {
  list: []
}, {
  getList: async (value, option) => {
    const res = await option.query(doc["b" /* doc */].userAddressListOneUser);
    option.setData(Object(utils["f" /* fpMergePre */])({
  ...
  setDefault: async (value, option) => {
    ...
    const res = await option.mutate(doc["b" /* doc */].setUserAddressDefault, {
      data: {
        id: value.id
      }
    });
...
const ListBox = external_styled_components_default.a.div.withConfig({
  ...
  componentId: "sc-144brw0-0"
})([""]);
const ListItem = external_styled_components_default.a.div.withConfig({
  displayName: "list__ListItem",
  componentId: "sc-144brw0-1"
})(["display:flex;height:80px;align-items:center;padding-left:20px;border-bottom:1px solid ", ";> svg{}> main{margin-left:10px;flex-grow:1;}"], colors_["grey"][200]);
const MyAddress = () => {
  const router = Object(router_["useRouter"])();
  const {
    state: stateMAM,
    actions: actionsMAM
  } = Object(useStore["b" /* useStoreModel */])(myAddressModel);
  Object(external_react_["useEffect"])(() => {
    actionsMAM.getList();
  }, []);
  ...
  }, __jsx(Streetview_default.a, {
    fontSize: 'large'
  }), __jsx("main", null, __jsx("header", null, value.name), __jsx("footer", null, value.combineAddress)), __jsx("aside", null, value.isDefault && __jsx("span", {
    style: {
      fontSize: '14px'
    }
  }, Object(dealKey["a" /* ls */])('默认')) || __jsx(core_["Button"], {
    size: 'small',
    variant: 'outlined',
    onClick: async () => {
  ...
  }, Object(dealKey["a" /* ls */])('设为默认')), __jsx(core_["Button"], {
    size: 'small',
    variant: 'text',
    color: 'secondary',
    onClick: () => router.push('/me/myAddress/edit/[id]', `/me/myAddress/edit/${value.id}`)
  }, Object(dealKey["a" /* ls */])('编辑')))))), __jsx("div", {
    style: {
      padding: '0 20px',
      marginTop: '20px'
    }
  ...
  }, Object(dealKey["a" /* ls */])('新增'))));
};
// CONCATENATED MODULE: ./pages/me/myAddress/index.tsx

/* harmony default export */ var myAddress = __webpack_exports__["default"] = (MyAddress);
