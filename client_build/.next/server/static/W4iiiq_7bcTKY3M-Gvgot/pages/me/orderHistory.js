...
module.exports = __webpack_require__("Zfth");
...
// CONCATENATED MODULE: ./utils/view/me/orderHistory/orderHistory.tsx
...
const orderHistoryModel = Object(modelUtil["c" /* modelFactory */])('orderHistoryModel', {
  state: 0,
  orderList: []
}, {
  ...
  getList: async (value, option) => {
    const res = await option.query(doc["b" /* doc */].orderList, {
      data: {
...
})(["height:18px;width:100%;background:", ";"], colors_["grey"][100]);
const Item = external_styled_components_default()('div').withConfig({
  displayName: "orderHistory__Item",
  componentId: "sc-1sgveef-1"
})(["&&&{padding:20px;display:flex;flex-direction:column;align-items:stretch;> header{display:flex;justify-content:space-between;}> section{margin-top:10px;text-align:right;> span{color:", ";}}> footer{text-align:right;margin-top:10px;}}"], common["a" /* mpStyle */].red);
const ImgList = external_styled_components_default()(core_["ButtonBase"]).withConfig({
...
const OrderHistory = () => {
  ...
  const {
    state: ohState,
    actions: ohActions
  } = Object(useStore["b" /* useStoreModel */])(orderHistoryModel);
  Object(external_react_["useEffect"])(() => {
    ohActions.getList();
  }, []);
  return __jsx("div", null, __jsx(HeaderTitle["a" /* HeaderTitle */], {
    ...
    value: 0,
    label: Object(dealKey["a" /* ls */])('全部')
  }), __jsx(core_["Tab"], {
    value: ss_common_enum["g" /* OrderState */].Picking,
    label: Object(dealKey["a" /* ls */])('待收货/取货')
  }), __jsx(core_["Tab"], {
    value: ss_common_enum["g" /* OrderState */].Paid,
    label: Object(dealKey["a" /* ls */])('代付款')
  })), __jsx(BScroller["a" /* BScroller */], {
    boxHeight: 'calc(100vh - 108px)'
  }, (_ohState$orderList$li = ohState.orderList.list) === null || _ohState$orderList$li === void 0 ? void 0 : _ohState$orderList$li.map(value => {
    ...
    return __jsx(external_react_default.a.Fragment, {
      key: `ohState.orderList_${value === null || value === void 0 ? void 0 : value.id}`
    }, __jsx(Parting, null), __jsx(Item, null, __jsx("header", null, __jsx("span", null, Object(utils["d" /* formatDate */])(value === null || value === void 0 ? void 0 : value.createTime)), __jsx("aside", null, Object(ss_common_enum["m" /* orderStateToString */])(value === null || value === void 0 ? void 0 : value.state))), __jsx(ImgList, {
      onClick: () => router.push('/me/orderDetail/[id]', `/me/orderDetail/${value === null || value === void 0 ? void 0 : value.id}`)
    }, value === null || value === void 0 ? void 0 : (_value$rOrderProduct = value.rOrderProduct) === null || _value$rOrderProduct === void 0 ? void 0 : (_value$rOrderProduct$ = _value$rOrderProduct.filter(value => {
    ...
    })) === null || _value$rOrderProduct$ === void 0 ? void 0 : _value$rOrderProduct$.map(value1 => {
      ...
      return __jsx("img", {
        ...
        src: Object(img["a" /* dealImgUrl */])(value1 === null || value1 === void 0 ? void 0 : (_value1$product2 = value1.product) === null || _value1$product2 === void 0 ? void 0 : (_value1$product2$img = _value1$product2.img) === null || _value1$product2$img === void 0 ? void 0 : (_value1$product2$img$ = _value1$product2$img[0]) === null || _value1$product2$img$ === void 0 ? void 0 : _value1$product2$img$.url),
        alt: ""
      });
    }), __jsx("aside", null, __jsx(ArrowForwardIos_default.a, {
      htmlColor: colors_["grey"][400]
    }))), __jsx("section", null, "\u5171", value === null || value === void 0 ? void 0 : (_value$rOrderProduct2 = value.rOrderProduct) === null || _value$rOrderProduct2 === void 0 ? void 0 : _value$rOrderProduct2.reduce((pre, cur) => {
      var _cur$count;

      return pre + ((_cur$count = cur === null || cur === void 0 ? void 0 : cur.count) !== null && _cur$count !== void 0 ? _cur$count : 0);
    }, 0), "\u4EF6\u5546\u54C1 \u5B9E\u4ED8", __jsx("span", null, "$", (_value$actuallyPaid = value === null || value === void 0 ? void 0 : value.actuallyPaid) !== null && _value$actuallyPaid !== void 0 ? _value$actuallyPaid : 0)), __jsx("footer", null, __jsx(core_["Button"], {
      color: 'secondary',
      variant: 'contained',
      onClick: e => {
        console.log('123');
    ...
    }, Object(dealKey["a" /* ls */])('确认收货')))));
  }), __jsx(Parting, null)));
};
// CONCATENATED MODULE: ./pages/me/orderHistory.tsx

/* harmony default export */ var orderHistory = __webpack_exports__["default"] = (OrderHistory);
