...
module.exports = __webpack_require__("Hyw2");
...
// EXTERNAL MODULE: ./utils/view/register/index.tsx + 1 modules
var register = __webpack_require__("LBYo");

// EXTERNAL MODULE: ./utils/view/me/myInfo/updatePassword.tsx
var updatePassword = __webpack_require__("s+i5");
...
// CONCATENATED MODULE: ./utils/view/me/myCreditCard/edit/[id].tsx
...
const myCreditCardEditModel = Object(modelUtil["c" /* modelFactory */])('myCreditCardEditModel', {
  form: {
    number: '',
    code: '',
    name: '',
  ...
  submit: (value, option) => {
    ...
    return option.mutate(doc["b" /* doc */].saveUserPayCard, {
  ...
  getOne: async (value, option) => {
    ...
    const res = await option.query(doc["b" /* doc */].userPayCard, {
...
const MyCreditCardEdit = () => {
  ...
  const {
    state: stateMCCE,
    actions: actionsMCCE
  } = Object(useStore["b" /* useStoreModel */])(myCreditCardEditModel);
  ...
  }), __jsx(updatePassword["a" /* FieldContain */], null, [['信用卡号', 'number'], ['四位号码', 'code'], ['姓名', 'userName'], ['详细地址', 'addressDetail'], ['邮政编码', 'zipCode'], ['城市', 'city'], ['联系方式', 'contact']].map(v => {
    var _stateMCCE$form;

    return __jsx(register["a" /* SigninInput */], {
      key: `MyCreditCardEdit_${v[1]}`,
      label: Object(dealKey["a" /* ls */])(v[0]),
...
// CONCATENATED MODULE: ./pages/me/myCreditCard/edit/[id].tsx

/* harmony default export */ var _id_ = __webpack_exports__["default"] = (MyCreditCardEdit);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FieldContain; });
...
/* harmony import */ var _register__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("LBYo");
...
/* harmony import */ var _components_ButtonLoad_ButtonLoad__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("+kHn");
/* harmony import */ var _graphqlTypes_doc__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("i7FU");
...
/* harmony import */ var _tools_token__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("ysgU");
/* harmony import */ var _tools_commonAction__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("soTg");
var __jsx = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement;
...
const updatePasswordModel = Object(_ModelAction_modelUtil__WEBPACK_IMPORTED_MODULE_4__[/* modelFactory */ "c"])('updatePasswordModel', {
  form: {
    oldPassword: '',
    newPassword: '',
    confirmPassword: ''
  ...
  setForm: _tools_commonAction__WEBPACK_IMPORTED_MODULE_13__[/* setForm */ "a"],
  ...
  submit: async (value, option) => {
    ...
    if (!form.oldPassword || !form.newPassword) {
      return Object(_components_Message_Message__WEBPACK_IMPORTED_MODULE_10__[/* showMessage */ "b"])('请填写表单');
    }

    if (form.newPassword !== form.confirmPassword) {
      return Object(_components_Message_Message__WEBPACK_IMPORTED_MODULE_10__[/* showMessage */ "b"])('两次密码不一致');
    }

    const res = await option.mutate(_graphqlTypes_doc__WEBPACK_IMPORTED_MODULE_9__[/* doc */ "b"].updatePassword, {
      data: form
    });
    ...
    if (res === null || res === void 0 ? void 0 : (_res$updatePassword = res.updatePassword) === null || _res$updatePassword === void 0 ? void 0 : (_res$updatePassword$u = _res$updatePassword.user) === null || _res$updatePassword$u === void 0 ? void 0 : _res$updatePassword$u.id) {
      ...
      Object(_tools_token__WEBPACK_IMPORTED_MODULE_12__[/* setToken */ "b"])((_res$updatePassword2 = res.updatePassword) === null || _res$updatePassword2 === void 0 ? void 0 : (_res$updatePassword2$ = _res$updatePassword2.authBody) === null || _res$updatePassword2$ === void 0 ? void 0 : _res$updatePassword2$.token);
      Object(_tools_token__WEBPACK_IMPORTED_MODULE_12__[/* setToken */ "b"])((_res$updatePassword3 = res.updatePassword) === null || _res$updatePassword3 === void 0 ? void 0 : (_res$updatePassword3$ = _res$updatePassword3.authBody) === null || _res$updatePassword3$ === void 0 ? void 0 : _res$updatePassword3$.refreshtoken, 'refreshtoken');
...
const FieldContain = styled_components__WEBPACK_IMPORTED_MODULE_7___default.a.div.withConfig({
  displayName: "updatePassword__FieldContain",
  componentId: "sc-125gec2-0"
})(["padding:0 22px;", "{margin-top:10px;}"], _register__WEBPACK_IMPORTED_MODULE_2__[/* SigninInput */ "a"]);
const UpdatePassword = () => {
  const {
    state: stateUPM,
    actions: actionsUPM
  } = Object(_ModelAction_useStore__WEBPACK_IMPORTED_MODULE_5__[/* useStoreModel */ "b"])(updatePasswordModel);
  ...
  }), __jsx(FieldContain, null, __jsx(_register__WEBPACK_IMPORTED_MODULE_2__[/* SigninInput */ "a"], {
    label: Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_3__[/* ls */ "a"])('原始密码'),
    type: 'password',
    value: stateUPM.form.oldPassword,
    onChange: event => actionsUPM.setForm(['oldPassword', event.target.value])
  }), __jsx(_register__WEBPACK_IMPORTED_MODULE_2__[/* SigninInput */ "a"], {
    label: Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_3__[/* ls */ "a"])('新密码'),
    type: 'password',
    value: stateUPM.form.newPassword,
    onChange: event => actionsUPM.setForm(['newPassword', event.target.value])
  }), __jsx(_register__WEBPACK_IMPORTED_MODULE_2__[/* SigninInput */ "a"], {
    label: Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_3__[/* ls */ "a"])('确认密码'),
    type: 'password',
    value: stateUPM.form.confirmPassword,
    onChange: event => actionsUPM.setForm(['confirmPassword', event.target.value])
  }), __jsx(_components_ButtonLoad_ButtonLoad__WEBPACK_IMPORTED_MODULE_8__[/* ButtonLoad */ "a"], {
    style: {
      marginTop: '20px'
    },
    variant: 'contained',
  ...
  }, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_3__[/* ls */ "a"])('保存'))));
};
