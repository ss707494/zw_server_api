...
module.exports = __webpack_require__("TdSx");
...
// CONCATENATED MODULE: ./utils/view/me/helpCenter/helpDetail.tsx
...
const HelpDetailModel = Object(dialog["a" /* dialogModelFactory */])('HelpDetail', {
  problem: '',
  answer: '',
  id: '',
  sort: 0
...
const Header = external_styled_components_default.a.div.withConfig({
  displayName: "helpDetail__Header",
  componentId: "cvdlpu-0"
})(["font-size:large;font-weight:bold;"]);
const Content = external_styled_components_default.a.div.withConfig({
  displayName: "helpDetail__Content",
  componentId: "cvdlpu-1"
})(["padding:16px 0 32px;"]);
const Foot = external_styled_components_default.a.div.withConfig({
  displayName: "helpDetail__Foot",
  componentId: "cvdlpu-2"
})([""]);
const HelpDetail = () => {
  var _stateHelpDetailModel, _stateHelpDetailModel2;

  const {
    actions: actionsHelpDetailModel,
    state: stateHelpDetailModel
  } = Object(useStore["b" /* useStoreModel */])(HelpDetailModel);
  return __jsx(core_["Dialog"], {
    open: stateHelpDetailModel.open,
    onClose: actionsHelpDetailModel.onClose
  }, __jsx(core_["DialogContent"], null, __jsx(Header, null, (_stateHelpDetailModel = stateHelpDetailModel.dialogData) === null || _stateHelpDetailModel === void 0 ? void 0 : _stateHelpDetailModel.problem), __jsx(Content, null, (_stateHelpDetailModel2 = stateHelpDetailModel.dialogData) === null || _stateHelpDetailModel2 === void 0 ? void 0 : _stateHelpDetailModel2.answer), __jsx(Foot, null, __jsx(core_["Button"], {
    variant: 'contained',
    fullWidth: true,
    color: 'secondary',
    onClick: () => {
      stateHelpDetailModel.openResolve({
        ss: 123
      });
      actionsHelpDetailModel.onClose();
    }
  }, Object(dealKey["a" /* ls */])('知道了')))));
};
// CONCATENATED MODULE: ./utils/view/me/helpCenter/helpCenter.tsx
...
const HelpCenterModel = Object(modelUtil["c" /* modelFactory */])('HelpCenter', {
  typeList: [],
  problemListData: {}
}, {
  getData: async (value, option) => {
    ...
    const helpDocumentationType = await option.query(doc["b" /* doc */].getDataConfig, {
      data: {
        type: ss_common_enum["d" /* DictTypeEnum */].HelpDocumentationType
      }
    });
    const helpDocumentation = await option.query(doc["b" /* doc */].getDataConfig, {
      data: {
        type: ss_common_enum["d" /* DictTypeEnum */].HelpDocumentation
      }
    });
...
const ExpansionPanelDetailsCus = external_styled_components_default()(core_["ExpansionPanelDetails"]).withConfig({
  displayName: "helpCenter__ExpansionPanelDetailsCus",
  componentId: "xqxd49-1"
})(["&&&{flex-direction:column;padding:0 16px;}"]);
const ListButton = external_styled_components_default()(core_["Button"]).withConfig({
  displayName: "helpCenter__ListButton",
  componentId: "xqxd49-2"
})(["&&&{background:", ";margin-bottom:16px;.MuiButton-label{justify-content:initial;padding-left:8px;position:relative;&:before{position:absolute;left:-5px;top:-32px;content:'.';color:", ";display:flex;align-items:center;font-size:36px;}}}"], colors_["grey"][300], common["a" /* mpStyle */].red);
const HelpCenter = () => {
  ...
  } = Object(useStore["b" /* useStoreModel */])(HelpCenterModel);
  const {
    actions: actionsHelpDetailModel
  } = Object(useStore["b" /* useStoreModel */])(HelpDetailModel);
  ...
  return helpCenter_jsx("div", null, helpCenter_jsx(HeaderTitle["a" /* HeaderTitle */], {
    title: '帮助中心'
  }), helpCenter_jsx(Box, null, (_stateHelpCenterModel = stateHelpCenterModel.typeList) === null || _stateHelpCenterModel === void 0 ? void 0 : _stateHelpCenterModel.map(v => {
    var _stateHelpCenterModel2, _stateHelpCenterModel3;

    return helpCenter_jsx(core_["ExpansionPanel"], {
      key: `typeList${v === null || v === void 0 ? void 0 : v.id}`
    }, helpCenter_jsx(core_["ExpansionPanelSummary"], {
      expandIcon: helpCenter_jsx(icons_["ExpandMore"], null)
    }, v === null || v === void 0 ? void 0 : v.name), helpCenter_jsx(ExpansionPanelDetailsCus, null, stateHelpCenterModel === null || stateHelpCenterModel === void 0 ? void 0 : (_stateHelpCenterModel2 = stateHelpCenterModel.problemListData) === null || _stateHelpCenterModel2 === void 0 ? void 0 : (_stateHelpCenterModel3 = _stateHelpCenterModel2[v === null || v === void 0 ? void 0 : v.id]) === null || _stateHelpCenterModel3 === void 0 ? void 0 : _stateHelpCenterModel3.map(pro => helpCenter_jsx(ListButton, {
  ...
  })), helpCenter_jsx(HelpDetail, null));
};
// CONCATENATED MODULE: ./pages/me/helpCenter/index.tsx

/* harmony default export */ var helpCenter = __webpack_exports__["default"] = (HelpCenter);
