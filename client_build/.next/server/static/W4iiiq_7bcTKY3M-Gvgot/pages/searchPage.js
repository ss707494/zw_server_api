...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getPromoCodeItem; });
...
const getPromoCodeItem = (item, user) => {
  return item.promoCodeType === _ss_common_enum__WEBPACK_IMPORTED_MODULE_7__[/* PromoCodeTypeEnum */ "i"].DarenCard ? __jsx(CardBox, {
    ...
    alt: ""
  })), __jsx(Title, null, item.title), __jsx(Remark, null, item.remark), __jsx(Number, null), __jsx(Time, null, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_3__[/* ls */ "a"])('使用时间'), ":", Object(_tools_utils__WEBPACK_IMPORTED_MODULE_10__[/* formatDate */ "d"])(item.effectiveDateStart), "-", Object(_tools_utils__WEBPACK_IMPORTED_MODULE_10__[/* formatDate */ "d"])(item.effectiveDateEnd)), __jsx(Action, null, __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_5__["Button"], {
    color: 'secondary',
    variant: 'contained',
    fullWidth: true,
    onClick: () => {
...
module.exports = __webpack_require__("Y2WJ");
...
// EXTERNAL MODULE: ./utils/view/card/[type].tsx
var _type_ = __webpack_require__("/FI/");

// EXTERNAL MODULE: ./utils/components/ProductItem/UpdateShopCart.tsx
var UpdateShopCart = __webpack_require__("vo3K");

// CONCATENATED MODULE: ./utils/view/home/searchPage.tsx
...
const SearchPageModel = Object(modelUtil["c" /* modelFactory */])('SearchPage', {
  form: {
    keyword: ''
  },
  productList: [],
  ...
  getData: async (value, option) => {
    ...
    const res = await option.query(doc["b" /* doc */].searchData, {
...
const SearchInput = external_styled_components_default.a.div.withConfig({
...
const SearchPage = () => {
  ...
  } = Object(useStore["b" /* useStoreModel */])(SearchPageModel);
  Object(external_react_["useEffect"])(() => {}, []);
  return __jsx("div", null, __jsx(HeaderTitle["a" /* HeaderTitle */], {
    title: '搜索',
    LeftIcon: Close_default.a,
    showCart: true
  }), __jsx(SearchInput, null, __jsx(lab_["Autocomplete"], {
    size: 'small',
    freeSolo: true,
    ...
    renderInput: params => __jsx(core_["TextField"], _extends({}, params, {
      autoFocus: true,
      margin: "normal",
      variant: "outlined",
      InputProps: {
        endAdornment: __jsx(core_["InputAdornment"], {
          position: 'end'
  ...
  })), stateSearchPageModel.productList.length > 0 && __jsx(external_react_default.a.Fragment, null, __jsx(Title, null, Object(dealKey["a" /* ls */])('零售商品')), __jsx(ListBox, null, stateSearchPageModel.productList.map(value => __jsx(ProductItem["c" /* ProductItemOneRow */], {
    key: `productList${value.id}`,
    product: value
  }))), __jsx(Box["b" /* Space */], {
    h: 16
  }), __jsx(core_["Divider"], null)), stateSearchPageModel.groupProductList.length > 0 && __jsx(external_react_default.a.Fragment, null, __jsx(Title, null, Object(dealKey["a" /* ls */])('拼团商品')), __jsx(ListBox, null, stateSearchPageModel.groupProductList.map(value => __jsx(ProductItem["a" /* GroupProductItem */], {
    key: `productList${value.id}`,
    product: value
  }))), __jsx(Box["b" /* Space */], {
    h: 16
  }), __jsx(core_["Divider"], null)), stateSearchPageModel.darenCardPromoCodeList.length > 0 && __jsx(external_react_default.a.Fragment, null, __jsx(Title, null, Object(dealKey["a" /* ls */])('达人卡')), __jsx(ListBox, null, stateSearchPageModel.darenCardPromoCodeList.map(value => Object(_type_["b" /* getPromoCodeItem */])(value, stateSearchPageModel.user))), __jsx(Box["b" /* Space */], {
    h: 16
  }), __jsx(core_["Divider"], null)), stateSearchPageModel.promoCodePromoCodeList.length > 0 && __jsx(external_react_default.a.Fragment, null, __jsx(Title, null, Object(dealKey["a" /* ls */])('优惠码')), __jsx(ListBox, null, stateSearchPageModel.promoCodePromoCodeList.map(value => Object(_type_["b" /* getPromoCodeItem */])(value, stateSearchPageModel.user))), __jsx(Box["b" /* Space */], {
    h: 16
  }), __jsx(core_["Divider"], null)), __jsx(UpdateShopCart["a" /* UpdateShopCart */], null));
};
// CONCATENATED MODULE: ./pages/searchPage/index.tsx

/* harmony default export */ var searchPage = __webpack_exports__["default"] = (SearchPage);
