...
module.exports = __webpack_require__("4JC/");
...
})(["height:45px;box-shadow:", ";display:flex;justify-content:space-between;padding:0 16px;align-items:center;"], common["a" /* mpStyle */].shadow['1']);
...
const HeaderSearch = () => {
  return __jsx(Box, null, __jsx(Logo, null, __jsx("img", {
    ...
    alt: ""
  })), __jsx(Title, null, Object(dealKey["a" /* ls */])('逛店')), __jsx(ShoppingCartIconButton["a" /* ShoppingCartIconButton */], null));
};
...
const HomeAppModule = type => function ({
  ...
  return appModule_jsx("div", null, appModule_jsx(HeaderSearch, null), appModule_jsx(BScroller["a" /* BScroller */], null, appModule_jsx("div", {
    className: style_default.a.dynamic([["1873098083", [colors_["grey"][600]]]]) + " " + 'common_box'
  }, appModule_jsx("div", {
    className: style_default.a.dynamic([["1873098083", [colors_["grey"][600]]]]) + " " + 'tip'
  }, appModule_jsx("aside", {
    className: style_default.a.dynamic([["1873098083", [colors_["grey"][600]]]])
  }, "\u70ED\u641C:"), ['薯条', '小龙虾'].map(value => appModule_jsx("span", {
    key: `tip_${value}`,
    className: style_default.a.dynamic([["1873098083", [colors_["grey"][600]]]])
  }, value))), appModule_jsx("div", {
...
// CONCATENATED MODULE: ./utils/view/productList/SortDrawer.tsx
var __jsx = external_react_default.a.createElement;
...
const Contain = external_styled_components_default.a.div.withConfig({
  displayName: "SortDrawer__Contain",
  componentId: "sc-1ttft6y-0"
})(["width:70vw;> header{padding:30px 20px 20px;border-bottom:1px solid ", ";}"], colors_["grey"][200]);
const Item = external_styled_components_default()(core_["ButtonBase"]).withConfig({
  displayName: "SortDrawer__Item",
  componentId: "sc-1ttft6y-1"
...
const SortDrawer = () => {
  ...
  } = Object(useStore["b" /* useStoreModel */])(productListModel);
  return __jsx(core_["Drawer"], {
    open: stateProductList.sortShow,
    onClose: actionsProductList.closeSort
  }, __jsx(Contain, null, __jsx("header", null, Object(dealKey["a" /* ls */])('排序')), __jsx("main", null, Object.keys(sortTypeEnum).map(v => __jsx(Item, {
    key: `orderTypeEnum_${v}`,
    onClick: () => {
      actionsProductList.changeSort(v);
      actionsProductList.closeSort();
    }
  }, __jsx("header", null, sortTypeLabel[v]), __jsx("footer", null, __jsx(core_["Radio"], {
    checked: v === stateProductList.params.sortType
  })))))));
};
// CONCATENATED MODULE: ./utils/view/productList/FilterDrawer.tsx
var FilterDrawer_jsx = external_react_default.a.createElement;
...
const FilterDrawer_Contain = external_styled_components_default.a.div.withConfig({
  displayName: "FilterDrawer__Contain",
  componentId: "piu186-0"
})(["width:70vw;> header{padding:30px 20px 20px;border-bottom:1px solid ", ";}"], colors_["grey"][200]);
const FilterDrawer_Item = external_styled_components_default()(core_["ButtonBase"]).withConfig({
  displayName: "FilterDrawer__Item",
  componentId: "piu186-1"
})(["&&&{width:100%;display:flex;align-items:center;justify-content:space-between;padding:0 20px;}"]);
const FilterDrawer = () => {
  const {
    actions: actionsProductList,
  ...
  return FilterDrawer_jsx(core_["Drawer"], {
    open: stateProductList.filterShow,
    onClose: actionsProductList.closeFilter,
    anchor: 'right'
  }, FilterDrawer_jsx(FilterDrawer_Contain, null, FilterDrawer_jsx("header", null, Object(dealKey["a" /* ls */])('筛选')), FilterDrawer_jsx("main", null, Object(dealKey["a" /* ls */])('暂无数据'))));
};
...
// CONCATENATED MODULE: ./utils/view/productList/[id].tsx
...
const productListModel = Object(modelUtil["c" /* modelFactory */])('productListModel', {
  category: {},
  productList: [],
  sortShow: false,
  params: {
  ...
  getCategory: async (value, option) => {
    ...
    const res = await option.query(doc["b" /* doc */].oneCategory, {
      data: value
    });
    option.setData(Object(utils["f" /* fpMergePre */])({
  ...
  getData: async (value, option) => {
    ...
    const res = await option.query(doc["b" /* doc */].productList, {
      productInput: value,
      orderByInput: {
...
const HeaderTab = external_styled_components_default.a.div.withConfig({
...
const ProductList = () => {
  ...
  }), _id_jsx(HeaderTab, null, _id_jsx(core_["Button"], {
    fullWidth: true,
    onClick: async () => {
  ...
  }, Object(dealKey["a" /* ls */])('排序'), _id_jsx(Sort_default.a, null)), _id_jsx(core_["Button"], {
    fullWidth: true,
    onClick: () => actionsPLM.openFilter()
  }, Object(dealKey["a" /* ls */])('筛选'), _id_jsx(FilterList_default.a, null))), _id_jsx(BScroller["a" /* BScroller */], {
    boxHeight: 'calc(100vh - 100px)'
  }, _id_jsx(ListBox, {
    columns: stateHomeTabs.homeType === appModule["b" /* HomeType */].group ? 1 : 2
  }, statePLM.productList.map(value => stateHomeTabs.homeType === appModule["b" /* HomeType */].group && _id_jsx(ProductItem["a" /* GroupProductItem */], {
    product: value,
    key: `ProductItem_${value.id}`
  }) || _id_jsx(ProductItem["b" /* ProductItem */], {
    key: `ProductItem_${value.id}`,
    product: value
  })))), _id_jsx(SortDrawer, null), _id_jsx(FilterDrawer, null), _id_jsx(UpdateShopCart["a" /* UpdateShopCart */], null));
};
// CONCATENATED MODULE: ./pages/productList/[id].tsx

/* harmony default export */ var _id_ = __webpack_exports__["default"] = (ProductList);
...
const PromotionFlashSale = () => {
  ...
  return PromotionFlashSale_jsx("div", null, PromotionFlashSale_jsx(Tip, null, PromotionFlashSale_jsx("main", null, Object(dealKey["a" /* ls */])('限时选购')), PromotionFlashSale_jsx("span", null, "0"), PromotionFlashSale_jsx("span", null, "0"), ":", PromotionFlashSale_jsx("span", null, "0"), PromotionFlashSale_jsx("span", null, "0"), ":", PromotionFlashSale_jsx("span", null, "0"), PromotionFlashSale_jsx("span", null, "0")), statePromotionFlashSale.productList.map(product => PromotionFlashSale_jsx(ProductItem["c" /* ProductItemOneRow */], {
...
const SalesRank = () => {
  ...
  return SalesRank_jsx(SalesRank_Box, null, SalesRank_jsx(core_["Tabs"], {
    ...
    h: 16
  }), stateSalesRankModel.listData.map(product => homeTabsState.homeType === appModule["b" /* HomeType */].group ? SalesRank_jsx(ProductItem["a" /* GroupProductItem */], {
    product: product,
