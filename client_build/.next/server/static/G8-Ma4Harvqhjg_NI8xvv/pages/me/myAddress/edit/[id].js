...
module.exports = __webpack_require__("EJv9");
...
// CONCATENATED MODULE: ./utils/view/me/myAddress/edit/[id].tsx
...
const myAddressEditModel = Object(modelUtil["c" /* modelFactory */])('myAddressEditModel', {
  form: {
    name: '',
    address: '',
    zip: '',
  ...
  submit: (value, option) => {
    ...
    return option.mutate(doc["b" /* doc */].saveUserAddress, {
  ...
  getOne: async (value, option) => {
    ...
    const res = await option.query(doc["b" /* doc */].userAddress, {
...
const MyAddressEdit = () => {
  ...
  const {
    state: stateMAEM,
    actions: actionsMAEM
  } = Object(useStore["b" /* useStoreModel */])(myAddressEditModel);
  ...
  }), __jsx(updatePassword["a" /* FieldContain */], null, [['姓名', 'name'], ['邮政编码', 'zip'], ['州', 'province', __jsx(core_["TextField"], {
  ...
  }, ss_common_enum["j" /* ProvinceData */].map(item => __jsx(core_["MenuItem"], {
    key: `provinceData_${item[0]}`,
    value: item[1]
  }, item[1])))], ['城市', 'city'], ['地区', 'district'], ['详细地址', 'address'], ['联系方式', 'contactInformation']].map(v => {
    var _stateMAEM$form;

    return v[2] && v[2] || __jsx(register["a" /* SigninInput */], {
...
// CONCATENATED MODULE: ./pages/me/myAddress/edit/[id].tsx

/* harmony default export */ var _id_ = __webpack_exports__["default"] = (MyAddressEdit);
