...
module.exports = __webpack_require__("Zs22");
...
// CONCATENATED MODULE: ./utils/view/me/myCreditCard/list.tsx
...
const myCreditCardListModel = Object(modelUtil["c" /* modelFactory */])('myCreditCardListModel', {
  list: []
}, {
  getList: async (value, option) => {
    const res = await option.query(doc["b" /* doc */].payCardListOneUser);
  ...
  setDefault: async (value, option) => {
    ...
    const res = await option.mutate(doc["b" /* doc */].setUserPayCardDefault, {
      data: {
        id: value.id
      }
    });
...
const MyCreditCardList = () => {
  const router = Object(router_["useRouter"])();
  const {
    state: stateMCC,
    actions: actionsMCC
  } = Object(useStore["b" /* useStoreModel */])(myCreditCardListModel);
  Object(external_react_["useEffect"])(() => {
    actionsMCC.getList();
  }, []);
  ...
  }, __jsx(Payment_default.a, {
    fontSize: 'large'
  }), __jsx("main", null, __jsx("header", null, value.name), __jsx("footer", null, value.number)), __jsx("aside", null, value.isDefault && __jsx("span", {
    style: {
      fontSize: '14px'
    }
...
// CONCATENATED MODULE: ./pages/me/myCreditCard/index.tsx

/* harmony default export */ var myCreditCard = __webpack_exports__["default"] = (MyCreditCardList);
