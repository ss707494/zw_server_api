...
module.exports = __webpack_require__("9pAu");
...
// EXTERNAL MODULE: ./utils/view/cart/index.tsx + 2 modules
var cart = __webpack_require__("c+KP");

// EXTERNAL MODULE: ./utils/view/cart/components/SelectAddress.tsx
var SelectAddress = __webpack_require__("q3aC");

// EXTERNAL MODULE: ./utils/view/cart/components/SelectCard.tsx
var SelectCard = __webpack_require__("n+/U");
...
// CONCATENATED MODULE: ./utils/view/groupProduct/groupOrderPage.tsx
...
})(["position:fixed;top:0;bottom:0;left:0;right:0;background:white;overflow-y:auto;> footer{position:fixed;bottom:0;box-sizing:border-box;box-shadow:", ";width:100vw;text-align:right;}"], common["a" /* mpStyle */].shadow["1"]);
const GroupOrderPage = () => {
  ...
  const addressData = stateSCM.dealAddressData(stateSCM);
  const cardData = ((_stateSCM$payCardList = stateSCM.payCardList) === null || _stateSCM$payCardList === void 0 ? void 0 : _stateSCM$payCardList.find(v => v.id === stateSCM.form.paymentMethodCardId)) || {};
  const productTotal = ((_product$priceOut = product.priceOut) !== null && _product$priceOut !== void 0 ? _product$priceOut : 0) * dealGroupNumbers(product) * stateGroupProduct.selectNum;
  const transportationCosts = stateSCM.dealTransportationCosts(stateSCM, productTotal);
  const actuallyPaid = stateGroupProduct.dealDiscountAmount(stateGroupProduct) + transportationCosts + Object(utils["a" /* dealMaybeNumber */])(stateSCM.form.saleTax) - Object(utils["a" /* dealMaybeNumber */])((_stateSCM$form = stateSCM.form) === null || _stateSCM$form === void 0 ? void 0 : _stateSCM$form.deductCoin);
  const generateCoin = actuallyPaid * 0.01;
  Object(external_react_["useEffect"])(() => {
  ...
  return stateOrderPageModel.show && __jsx(external_react_default.a.Fragment, null, __jsx(OrderPageBox, null, __jsx(HeaderTitle["a" /* HeaderTitle */], {
    ...
    priceOutTip: Object(dealKey["a" /* ls */])('基准价'),
    product: product
  }), __jsx("span", null, dealGroupNumbers(product) * stateGroupProduct.selectNum, product.groupAmountUnitString, "/", stateGroupProduct.selectNum, Object(dealKey["a" /* ls */])('份')))), __jsx(core_["TextField"], {
    style: {
      margin: '16px',
  ...
  }, Object(dealKey["a" /* ls */])(Object(ss_common_enum["l" /* getPickUpTypeName */])(ss_common_enum["h" /* PickUpTypeEnum */].Self))), __jsx(core_["MenuItem"], {
    value: ss_common_enum["h" /* PickUpTypeEnum */].Delivery
  }, Object(dealKey["a" /* ls */])(Object(ss_common_enum["l" /* getPickUpTypeName */])(ss_common_enum["h" /* PickUpTypeEnum */].Delivery)))), __jsx(orderPage["a" /* AddressBox */], null, __jsx("main", null, __jsx("header", null, `${addressData.combineAddress}`), __jsx("footer", null, `${addressData.name} ${addressData.contactInformation}`)), __jsx("aside", null, __jsx(core_["IconButton"], {
    onClick: async () => {
      const res = await actionsSAM.openClick();
    ...
    w: 20
  }), Object(dealKey["a" /* ls */])('付款方式')), __jsx(orderPage["b" /* CardBox */], null, __jsx("header", null, cardData.name), __jsx("footer", null, cardData.number), __jsx("aside", null, __jsx(core_["IconButton"], {
    onClick: async () => {
      const res = await actionsSelectCard.openClick();
    ...
    w: 20
  }), Object(dealKey["a" /* ls */])('使用达人币'), __jsx(Box["b" /* Space */], {
    w: 16
  }), __jsx("footer", null, Object(dealKey["a" /* ls */])('当月可用余额'), Object(utils["b" /* dealMoney */])(stateSCM.user.orderCoinCurrentMonth))), __jsx("div", null, __jsx(Box["b" /* Space */], {
    w: 20
  ...
  })), __jsx(orderPage["f" /* ShopTotal */], null, __jsx("header", null, Object(dealKey["a" /* ls */])('购物车总计')), __jsx("footer", null, Object(utils["b" /* dealMoney */])(productTotal))), __jsx(orderPage["f" /* ShopTotal */], null, __jsx("header", null, Object(dealKey["a" /* ls */])('份数折扣')), __jsx("footer", null, stateGroupProduct.numDiscount)), __jsx(orderPage["f" /* ShopTotal */], null, __jsx("header", null, Object(dealKey["a" /* ls */])('成团折上折')), __jsx("footer", null, stateGroupProduct.groupDiscount)), transportationCosts > 0 && __jsx(orderPage["f" /* ShopTotal */], null, __jsx("header", null, Object(dealKey["a" /* ls */])('运费')), __jsx("footer", null, Object(utils["b" /* dealMoney */])(transportationCosts))), __jsx(orderPage["f" /* ShopTotal */], null, __jsx("header", null, Object(dealKey["a" /* ls */])('达人币抵扣')), __jsx("footer", null, Object(utils["b" /* dealMoney */])(stateSCM.form.deductCoin, '-'))), __jsx(orderPage["f" /* ShopTotal */], {
    style: {
      fontSize: '18px'
    }
  }, __jsx("header", null, Object(dealKey["a" /* ls */])('订单总额')), __jsx("footer", null, Object(utils["b" /* dealMoney */])(actuallyPaid))), __jsx(Box["b" /* Space */], {
    h: 120
  }), __jsx(orderPage["c" /* FooterFit */], null, __jsx("header", null, Object(dealKey["a" /* ls */])('本次订单'), __jsx("span", null, Object(dealKey["a" /* ls */])((_stateSCM$userLevelLi = stateSCM.userLevelList.find(v => {
    var _stateSCM$user$userIn;

    return v.code === ((_stateSCM$user$userIn = stateSCM.user.userInfo) === null || _stateSCM$user$userIn === void 0 ? void 0 : _stateSCM$user$userIn.userLevel);
  })) === null || _stateSCM$userLevelLi === void 0 ? void 0 : _stateSCM$userLevelLi.name))), __jsx("footer", null, Object(dealKey["a" /* ls */])('将获得下月使用达人币 '), __jsx("span", null, Object(utils["b" /* dealMoney */])(generateCoin))), __jsx("aside", null, __jsx(ButtonLoad["a" /* ButtonLoad */], {
    variant: 'contained',
    color: 'secondary',
    onClick: async () => {
      var _stateSCM$user, _stateSCM$user$userIn2, _res$saveGroupOrder;

      if (Object(utils["a" /* dealMaybeNumber */])((_stateSCM$user = stateSCM.user) === null || _stateSCM$user === void 0 ? void 0 : _stateSCM$user.orderCoinCurrentMonth) < Object(utils["a" /* dealMaybeNumber */])(stateSCM.form.deductCoin)) {
        Object(Message["b" /* showMessage */])(Object(dealKey["a" /* ls */])('达人币余额不足'));
        return;
      }
  ...
  }, Object(dealKey["a" /* ls */])('提交订单')))))) || null;
};
// CONCATENATED MODULE: ./utils/view/groupProduct/[id].tsx
...
const groupProductModel = Object(modelUtil["c" /* modelFactory */])('groupProductModel', {
  ...
  getData: async (value, option) => {
    ...
    const res2 = await option.query(doc["c" /* getDataConfig */], {
      data: {
        type: ss_common_enum["d" /* DictTypeEnum */].GroupPrecision
      }
    }, {});
    option.setData(Object(utils["f" /* fpMergePre */])({
...
})(["background:", ";color:white;display:grid;grid-template-columns:1fr 120px;grid-template-rows:repeat(2,30px);align-items:center;> main{grid-area:1/1/3/2;padding-left:20px;> span{margin-left:16px;}}"], common["a" /* mpStyle */].red);
const Name = external_styled_components_default.a.div.withConfig({
  displayName: "id__Name",
  componentId: "sc-1c5vpsf-1"
})(["padding:16px 20px;display:flex;align-items:flex-end;> main{font-size:22px;margin-right:8px;flex-shrink:0;}> section{> span{padding:0 4px;background:", ";border-radius:4px;position:relative;bottom:-4px;margin-left:8px;display:inline-flex;align-items:center;}}"], colors_["grey"]['700']);
...
})(["position:fixed;height:60px;bottom:0;width:100vw;background:white;border-top:1px solid ", ";display:flex;align-items:center;justify-content:space-between;box-shadow:", ";> aside{padding-left:16px;color:", ";}"], common["a" /* mpStyle */].red, common["a" /* mpStyle */].shadow['1'], common["a" /* mpStyle */].red);
const GroupQueueListBox = external_styled_components_default.a.div.withConfig({
  displayName: "id__GroupQueueListBox",
  componentId: "sc-1c5vpsf-7"
})(["margin-top:16px;border-radius:8px;background:", ";display:flex;justify-content:space-between;align-items:center;padding:0 8px;"], prop => prop.select ? `linear-gradient(to right, ${common["a" /* mpStyle */].red}, #FC7361)` : colors_["grey"]['200']);
const GroupProduct = () => {
  ...
  return _id_jsx("div", null, _id_jsx(HeaderTitle["a" /* HeaderTitle */], {
  ...
  }), _id_jsx(PriceRed, null, _id_jsx("main", null, Object(dealKey["a" /* ls */])('基准价格'), _id_jsx("span", null, Object(utils["b" /* dealMoney */])(product.priceOut), "/", product.packingUnitString)), _id_jsx("aside", null, Object(dealKey["a" /* ls */])('已成团'), stateGroupProduct.groupQueueList.filter(v => v.sumFillAmount === (product === null || product === void 0 ? void 0 : product.groupPrecision)).length, Object(dealKey["a" /* ls */])('单')), _id_jsx("aside", null, Object(dealKey["a" /* ls */])('拼团中'), stateGroupProduct.groupQueueList.filter(v => {
  ...
  }).length, Object(dealKey["a" /* ls */])('单'))), _id_jsx(Name, null, _id_jsx("main", null, product.name), _id_jsx("section", null, product.groupRemark, "/", product.groupAmount, product.groupAmountUnitString, " ", `每一份${dealGroupNumbers(product)}${product.groupAmountUnitString}`, _id_jsx("br", null), Object(dealKey["a" /* ls */])('分团精度'), _id_jsx("span", null, [...Array(product.groupPrecision)].map((v, i) => i).map(value => _id_jsx(YellowStar, {
    key: value
  }))))), _id_jsx(GroupQueueBox, null, _id_jsx(Title, null, Object(dealKey["a" /* ls */])('拼团中')), stateGroupProduct.groupQueueList.filter(v => {
    ...
    return _id_jsx(GroupQueueListBox, {
      select: select,
      key: `GroupQueueListBox${groupQueue.id}`
    }, _id_jsx("aside", null, [...Array(product.groupPrecision)].map((v, i) => i).map(value => {
      var _groupQueue$sumFillAm;

      return value + 1 > ((_groupQueue$sumFillAm = groupQueue.sumFillAmount) !== null && _groupQueue$sumFillAm !== void 0 ? _groupQueue$sumFillAm : 0) + (select ? stateGroupProduct.selectNum : 0) ? _id_jsx(StarBorderRounded_default.a, {
        key: `clickStar${value}`,
        fontSize: 'large',
    ...
    })), _id_jsx("footer", null, Object(dealKey["a" /* ls */])(((_groupQueue$sumFillAm2 = groupQueue.sumFillAmount) !== null && _groupQueue$sumFillAm2 !== void 0 ? _groupQueue$sumFillAm2 : 0) + (select ? stateGroupProduct.selectNum : 0) === product.groupPrecision ? '成团啦' : '未成团')));
  })), _id_jsx(SmartMatch, null, _id_jsx("header", null, _id_jsx(Title, null, Object(dealKey["a" /* ls */])('智能匹配'))), _id_jsx("section", null, Object(dealKey["a" /* ls */])('请点击'), _id_jsx(StarBorderRounded_default.a, null), Object(dealKey["a" /* ls */])('确定您需要的份数')), _id_jsx("main", null, [...Array(product.groupPrecision)].map((v, i) => i).map(value => value + 1 > stateGroupProduct.selectNum ? _id_jsx(StarBorderRounded_default.a, {
    key: `clickStar${value}`,
    fontSize: 'large',
    onClick: () => actionsGroupProduct.updateSelectNum(value + 1)
  }) : _id_jsx(StarRounded_default.a, {
    ...
    fontSize: 'large',
    onClick: () => actionsGroupProduct.updateSelectNum(value + 1)
  }))), _id_jsx(Price, null, _id_jsx("main", null, _id_jsx("header", null, Object(utils["b" /* dealMoney */])(stateGroupProduct.dealDiscountAmountUnit(stateGroupProduct))), _id_jsx("footer", null, Object(dealKey["a" /* ls */])('折后价格'))), _id_jsx("div", null, "="), _id_jsx("section", null, _id_jsx("header", null, Object(utils["b" /* dealMoney */])((_product$priceOut = product.priceOut) !== null && _product$priceOut !== void 0 ? _product$priceOut : 0)), _id_jsx("footer", null, Object(dealKey["a" /* ls */])('基准价格'))), _id_jsx("div", null, "x"), _id_jsx("section", null, _id_jsx("header", null, stateGroupProduct.numDiscount), _id_jsx("footer", null, Object(dealKey["a" /* ls */])('份数折扣'))), _id_jsx("div", null, "x"), _id_jsx("section", null, _id_jsx("header", null, stateGroupProduct.groupDiscount), _id_jsx("footer", null, Object(dealKey["a" /* ls */])('成团折上折'))))), _id_jsx(Submit, null, _id_jsx("aside", null, Object(dealKey["a" /* ls */])('选择了'), stateGroupProduct.selectNum, Object(dealKey["a" /* ls */])('份')), _id_jsx(core_["Button"], {
  ...
  }, Object(dealKey["a" /* ls */])('去结算'))), _id_jsx(GroupOrderPage, null));
};
// CONCATENATED MODULE: ./pages/groupProduct/[id].tsx

/* harmony default export */ var _id_ = __webpack_exports__["default"] = (GroupProduct);
