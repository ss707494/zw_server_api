...
// CONCATENATED MODULE: ./utils/view/card/[type].tsx
var __jsx = external_react_default.a.createElement;
...
const cardModel = Object(modelUtil["c" /* modelFactory */])('cardModel', {
  promoCodeList: [],
  user: {}
}, {
  getList: async (value, option) => {
    ...
    const res = await option.query(doc["b" /* doc */].promoCodeList, {});
    const user = await option.query(doc["b" /* doc */].oneUser);
    option.setData(Object(utils["f" /* fpMergePre */])({
...
const MainBox = external_styled_components_default.a.div.withConfig({
  displayName: "type__MainBox",
  componentId: "sc-1gqv45y-0"
})(["padding:24px 24px 80px;"]);
const CardBox = external_styled_components_default()(core_["Card"]).withConfig({
...
const Remark = external_styled_components_default.a.div.withConfig({
  displayName: "type__Remark",
  componentId: "sc-1gqv45y-3"
})([""]);
const _type_Number = external_styled_components_default.a.div.withConfig({
  displayName: "type__Number",
  componentId: "sc-1gqv45y-4"
})(["font-size:14px;color:", ";"], colors_["grey"][500]);
const Time = external_styled_components_default.a.div.withConfig({
...
const CardBoxPromoCode = external_styled_components_default()(core_["Card"]).withConfig({
  displayName: "type__CardBoxPromoCode",
  componentId: "sc-1gqv45y-7"
})(["&&&{padding:24px;margin-bottom:24px;background-image:url(\"", "\");background-color:", ";box-shadow:inset 0 0 0 1000px rgba(0,0,0,.3);background-size:100% 100%;background-position:0 0;color:white;}", "{color:white;}", "{color:white;}"], p => p.background, colors_["grey"][200], _type_Number, Time);
const CodeBox = external_styled_components_default.a.div.withConfig({
  displayName: "type__CodeBox",
  componentId: "sc-1gqv45y-8"
})([""]);

const getItem = (item, user) => {
  return item.promoCodeType === ss_common_enum["i" /* PromoCodeTypeEnum */].DarenCard ? __jsx(CardBox, {
    key: `CardBox_${item.id}`
  }, __jsx("aside", null, __jsx("img", {
    src: Object(img["a" /* dealImgUrl */])(item.imgUrl),
    alt: ""
  })), __jsx(Title, null, item.title), __jsx(Remark, null, item.remark), __jsx(_type_Number, null), __jsx(Time, null, Object(dealKey["a" /* ls */])('使用时间'), ":", Object(utils["d" /* formatDate */])(item.effectiveDateStart), "-", Object(utils["d" /* formatDate */])(item.effectiveDateEnd)), __jsx(Action, null, __jsx(core_["Button"], {
    color: 'secondary',
    variant: 'contained',
    fullWidth: true,
    onClick: () => {
  ...
  }, Object(dealKey["a" /* ls */])('应用到购物车')))) : __jsx(CardBoxPromoCode, {
    key: `CardBoxPromoCode_${item.id}`,
    background: Object(img["a" /* dealImgUrl */])(item === null || item === void 0 ? void 0 : item.imgUrl)
  }, __jsx(Title, null, item.title), __jsx(Box["b" /* Space */], {
    h: 8
  }), __jsx(Remark, null, item.remark), __jsx(Box["b" /* Space */], {
    h: 8
  }), __jsx(Time, null, Object(dealKey["a" /* ls */])('使用时间'), ":", Object(utils["d" /* formatDate */])(item.effectiveDateStart), "-", Object(utils["d" /* formatDate */])(item.effectiveDateEnd)), __jsx(Box["b" /* Space */], {
    h: 8
  }), __jsx(CodeBox, null, Object(dealKey["a" /* ls */])('优惠码'), ":", item.code), __jsx(Box["b" /* Space */], {
    h: 8
  }), __jsx(Action, null, __jsx(core_["Button"], {
    variant: 'outlined',
    fullWidth: true,
    onClick: () => {
      if (item === null || item === void 0 ? void 0 : item.code) {
...
const CardType = () => {
  ...
  } = Object(useStore["b" /* useStoreModel */])(cardModel);
  Object(external_react_["useEffect"])(() => {
  ...
  return __jsx("div", null, __jsx(HeaderTitle["a" /* HeaderTitle */], {
    title: Object(dealKey["a" /* ls */])('达人专区')
  }), __jsx(core_["Tabs"], {
    variant: 'fullWidth',
    value: promoCodeType !== null && promoCodeType !== void 0 ? promoCodeType : ss_common_enum["i" /* PromoCodeTypeEnum */].DarenCard,
    onChange: (event, value) => router.push('/card/[type]', `/card/${value}`)
  }, __jsx(core_["Tab"], {
    value: ss_common_enum["i" /* PromoCodeTypeEnum */].DarenCard,
    label: Object(dealKey["a" /* ls */])('我的达人卡')
  }), __jsx(core_["Tab"], {
    value: ss_common_enum["i" /* PromoCodeTypeEnum */].PromoCode,
    label: Object(dealKey["a" /* ls */])('当前优惠促销')
  })), __jsx(BScroller["a" /* BScroller */], {
    boxHeight: 'calc(100vh - 188px)'
  }, __jsx(MainBox, null, stateCardModel.promoCodeList.filter(v => v.promoCodeType === promoCodeType).map(v => getItem(v, stateCardModel.user)))), __jsx(FootBar["a" /* FootBar */], null));
};
// CONCATENATED MODULE: ./pages/card/[type].tsx

/* harmony default export */ var _type_ = __webpack_exports__["default"] = (CardType);
