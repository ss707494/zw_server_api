...
// CONCATENATED MODULE: ./utils/view/login/model.ts
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
const loginModel = Object(modelUtil["c" /* modelFactory */])('loginModel', {
  form: {
    name: '',
    password: ''
  }
  ...
  setForm: ([path, value], option) => {
    option.setData(Object(utils["h" /* fpSetPre */])(`form.${path}`, value));
  },
  login: async (value, option) => {
    ...
    if (!(form === null || form === void 0 ? void 0 : form.name) || !(form === null || form === void 0 ? void 0 : form.password)) {
      return Object(Message["b" /* showMessage */])(Object(dealKey["a" /* ls */])('请填写表单'));
    }

    const res = await option.query(doc["b" /* doc */].login, {
    ...
    if (res === null || res === void 0 ? void 0 : (_res$login = res.login) === null || _res$login === void 0 ? void 0 : _res$login.token) {
      ...
      Object(token["b" /* setToken */])(res === null || res === void 0 ? void 0 : (_res$login2 = res.login) === null || _res$login2 === void 0 ? void 0 : _res$login2.token);
      Object(token["b" /* setToken */])(res === null || res === void 0 ? void 0 : (_res$login3 = res.login) === null || _res$login3 === void 0 ? void 0 : _res$login3.refreshtoken, 'refreshtoken');
      await router_default.a.push('/home');
    }
  },
  goToSignin: async (value, option) => {
    await router_default.a.push('/register');
  },
  goHome: async (value, option) => {
    await router_default.a.push('/home/[appModule]', '/home/categorySelection');
  }
});
...
// CONCATENATED MODULE: ./utils/view/login/index.tsx
...
function Login() {
  const {
    state,
    actions
  } = Object(useStore["b" /* useStoreModel */])(loginModel);
  return __jsx(Box["a" /* Box */], null, __jsx(RegisterHeader["a" /* RegisterHeader */], null), __jsx("section", {
    style: {
      height: '15vh'
    }
  }), __jsx(register["b" /* SigninLabel */], null, Object(dealKey["a" /* ls */])('账号')), __jsx(register["a" /* SigninInput */], {
    value: state.form.name,
    onChange: event => actions.setForm(['name', event.target.value])
  }), __jsx(register["b" /* SigninLabel */], null, Object(dealKey["a" /* ls */])('密码')), __jsx(register["a" /* SigninInput */], {
    type: 'password',
    value: state.form.password,
    onChange: event => actions.setForm(['password', event.target.value])
  }), __jsx(register["c" /* SigninSubButton */], {
    size: 'large',
    color: 'secondary',
    variant: 'contained',
    fullWidth: true,
  ...
  }, Object(dealKey["a" /* ls */])('注册')), __jsx(register["c" /* SigninSubButton */], {
    style: {
      marginTop: '10px'
    },
    size: 'small',
