...
// CONCATENATED MODULE: ./utils/view/category/[id].tsx
...
const CategoryPage = () => {
    ...
    return _id_jsx(CategoryItemStyle, {
      ...
      onClick: async () => {
        ...
        if (((_await$actionsCI$getL = await actionsCI.getLevel({
          ...
          await router_default.a.push(`/productList/[id]${_query}`, `/productList/${v.id}${_query}`);
        } else {
          await router_default.a.push(`/category/[id]${_query}`, `/category/${v.id}${_query}`);
        }
      }
    }, _id_jsx("img", {
      src: Object(img["a" /* dealImgUrl */])(v.imgUrl),
  ...
  return _id_jsx("div", null, _id_jsx(HeaderTitle["a" /* HeaderTitle */], {
    ...
    onClick: async () => {
      ...
      await router_default.a.push(`/category/[id]${_query}`, `/category/${e === null || e === void 0 ? void 0 : e.id}${_query}`);
    }
