...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return orderDetailModel; });
...
/* harmony import */ var _components_BScroll_BScroller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("Z3gB");
...
/* harmony import */ var _graphqlTypes_doc__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("i7FU");
/* harmony import */ var _tools_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("cBzo");
/* harmony import */ var _ModelAction_useStore__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("U81q");
...
/* harmony import */ var _ss_common_enum__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("4Rmy");
/* harmony import */ var _style_common__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("ZtJr");
/* harmony import */ var _material_ui_core_colors__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("+FwM");
...
/* harmony import */ var _tools_img__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("Oj7+");
...
const orderDetailModel = Object(_ModelAction_modelUtil__WEBPACK_IMPORTED_MODULE_4__[/* modelFactory */ "c"])('orderDetail', {
  orderInfo: {},
  selfAddress: []
}, {
  getDetail: async (value, option) => {
    ...
    const res = await option.query(_graphqlTypes_doc__WEBPACK_IMPORTED_MODULE_5__[/* doc */ "b"].orderDetail, {
      id: value
    });
    option.setData(Object(_tools_utils__WEBPACK_IMPORTED_MODULE_6__[/* fpMergePre */ "f"])({
  ...
  updateOrder: async (value, option) => {
    return await option.mutate(_graphqlTypes_doc__WEBPACK_IMPORTED_MODULE_5__[/* doc */ "b"].updateOrder, {
...
const Top = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.div.withConfig({
  displayName: "orderDetail__Top",
  componentId: "lz0d8y-1"
})(["margin-top:10px;font-size:18px;display:flex;> aside{margin-left:20px;color:", ";}"], _style_common__WEBPACK_IMPORTED_MODULE_11__[/* mpStyle */ "a"].red);
const InfoLabel = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.div.withConfig({
  displayName: "orderDetail__InfoLabel",
  componentId: "lz0d8y-2"
})(["display:flex;margin-top:16px;> aside{color:", ";width:80px;}"], _material_ui_core_colors__WEBPACK_IMPORTED_MODULE_12__["grey"][600]);
const GreyPart = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.div.withConfig({
  displayName: "orderDetail__GreyPart",
  componentId: "lz0d8y-3"
})(["margin-top:12px;position:relative;left:-20px;width:100vw;height:12px;background:", ";"], _material_ui_core_colors__WEBPACK_IMPORTED_MODULE_12__["grey"][200]);
const ProductBox = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.div.withConfig({
  displayName: "orderDetail__ProductBox",
  componentId: "lz0d8y-4"
})(["display:grid;padding-top:4vw;margin-bottom:10px;grid-template-columns:min-content 1fr 30vw;> img{grid-area:1/1/4/2;width:20vw;height:20vw;margin-right:14px;}> section{grid-area:1/2/2/4;font-size:20px;}> main{padding:10px 0;grid-area:2/2/3/4;font-size:14px;color:", ";}> footer{display:flex;> aside{text-decoration:line-through;}> span{margin-left:5px;color:", ";font-size:17px;}}> aside{> button{border-radius:10px;padding:2px 14px;}}"], _material_ui_core_colors__WEBPACK_IMPORTED_MODULE_12__["grey"][500], _style_common__WEBPACK_IMPORTED_MODULE_11__[/* mpStyle */ "a"].red);
const Sum = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.div.withConfig({
...
const OrderDetail = () => {
  ...
  const {
    state: stateOD,
    actions: actionsOD
  } = Object(_ModelAction_useStore__WEBPACK_IMPORTED_MODULE_7__[/* useStoreModel */ "b"])(orderDetailModel);
  ...
  return __jsx("div", null, __jsx(_components_HeaderTitle_HeaderTitle__WEBPACK_IMPORTED_MODULE_1__[/* HeaderTitle */ "a"], {
    title: '订单详情'
  }), !(orderInfo === null || orderInfo === void 0 ? void 0 : orderInfo.id) ? __jsx("div", null) : __jsx(_components_BScroll_BScroller__WEBPACK_IMPORTED_MODULE_2__[/* BScroller */ "a"], {
    boxHeight: 'calc(100vh - 60px)'
  }, __jsx(Box, null, __jsx(Top, null, __jsx("section", null, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_9__[/* ls */ "a"])(Object(_tools_utils__WEBPACK_IMPORTED_MODULE_6__[/* formatDate */ "d"])(orderInfo.createTime))), __jsx("aside", null, Object(_ss_common_enum__WEBPACK_IMPORTED_MODULE_10__[/* orderStateToString */ "m"])(orderInfo === null || orderInfo === void 0 ? void 0 : orderInfo.state))), __jsx(InfoLabel, null, __jsx("aside", null, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_9__[/* ls */ "a"])('送货地址'), " :"), __jsx("section", null, orderInfo.pickUpType === _ss_common_enum__WEBPACK_IMPORTED_MODULE_10__[/* PickUpTypeEnum */ "h"].Self && (v => `${v.province} ${v.city} ${v.streetAddress}`)(stateOD.selfAddress.find(v => v.id === orderInfo.selfAddressId)) || ((_orderInfo$userAddres = orderInfo.userAddress) === null || _orderInfo$userAddres === void 0 ? void 0 : _orderInfo$userAddres.combineAddress))), __jsx(InfoLabel, null, __jsx("aside", null, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_9__[/* ls */ "a"])('订单编号'), " :"), __jsx("section", null, orderInfo.number)), __jsx(InfoLabel, null, __jsx("aside", null, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_9__[/* ls */ "a"])('支付方式'), " :"), __jsx("section", null, __jsx("header", null, orderInfo === null || orderInfo === void 0 ? void 0 : (_orderInfo$userPayCar = orderInfo.userPayCard) === null || _orderInfo$userPayCar === void 0 ? void 0 : _orderInfo$userPayCar.code), __jsx("main", null, Object(_tools_utils__WEBPACK_IMPORTED_MODULE_6__[/* formatDate */ "d"])(orderInfo === null || orderInfo === void 0 ? void 0 : (_orderInfo$userPayCar2 = orderInfo.userPayCard) === null || _orderInfo$userPayCar2 === void 0 ? void 0 : _orderInfo$userPayCar2.expirationTime, 'MM/yy')), __jsx("footer", null, orderInfo === null || orderInfo === void 0 ? void 0 : (_orderInfo$userPayCar3 = orderInfo.userPayCard) === null || _orderInfo$userPayCar3 === void 0 ? void 0 : _orderInfo$userPayCar3.userName))), __jsx(GreyPart, null), (_orderInfo$rOrderProd = orderInfo.rOrderProduct) === null || _orderInfo$rOrderProd === void 0 ? void 0 : _orderInfo$rOrderProd.map(rOrderProduct => {
    ...
    return __jsx(ProductBox, {
      ...
      src: Object(_tools_img__WEBPACK_IMPORTED_MODULE_13__[/* dealImgUrl */ "a"])((_rOrderProduct$produc = rOrderProduct.product) === null || _rOrderProduct$produc === void 0 ? void 0 : (_rOrderProduct$produc2 = _rOrderProduct$produc.img) === null || _rOrderProduct$produc2 === void 0 ? void 0 : (_rOrderProduct$produc3 = _rOrderProduct$produc2[0]) === null || _rOrderProduct$produc3 === void 0 ? void 0 : _rOrderProduct$produc3.url),
      alt: ""
    }), __jsx("section", null, (_rOrderProduct$produc4 = rOrderProduct.product) === null || _rOrderProduct$produc4 === void 0 ? void 0 : _rOrderProduct$produc4.name), __jsx("main", null, "\u72EC\u7ACB\u5305\u88C5"), __jsx("footer", null, __jsx("aside", null, Object(_tools_utils__WEBPACK_IMPORTED_MODULE_6__[/* dealMoney */ "b"])((_rOrderProduct$produc5 = rOrderProduct.product) === null || _rOrderProduct$produc5 === void 0 ? void 0 : _rOrderProduct$produc5.priceMarket)), __jsx("span", null, Object(_tools_utils__WEBPACK_IMPORTED_MODULE_6__[/* dealMoney */ "b"])((_rOrderProduct$produc6 = rOrderProduct.product) === null || _rOrderProduct$produc6 === void 0 ? void 0 : _rOrderProduct$produc6.priceOut))), __jsx("aside", null, __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_14__["Button"], {
      variant: 'contained'
  ...
  }), __jsx(Sum, null, __jsx("aside", null, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_9__[/* ls */ "a"])('小计')), __jsx("main", null, Object(_tools_utils__WEBPACK_IMPORTED_MODULE_6__[/* dealMoney */ "b"])(orderInfo.subtotal))), __jsx(Sum, null, __jsx("aside", null, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_9__[/* ls */ "a"])('优惠券折扣')), __jsx("main", null, Object(_tools_utils__WEBPACK_IMPORTED_MODULE_6__[/* dealMoney */ "b"])(0, '-'))), __jsx(Sum, null, __jsx("aside", null, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_9__[/* ls */ "a"])('运费')), __jsx("main", null, Object(_tools_utils__WEBPACK_IMPORTED_MODULE_6__[/* dealMoney */ "b"])(orderInfo.transportationCosts))), __jsx(Sum, null, __jsx("aside", null, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_9__[/* ls */ "a"])('达人币抵扣')), __jsx("main", null, Object(_tools_utils__WEBPACK_IMPORTED_MODULE_6__[/* dealMoney */ "b"])(orderInfo.deductCoin, '-'))), __jsx(Sum, null, __jsx("aside", null, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_9__[/* ls */ "a"])('实际支付')), __jsx("main", null, Object(_tools_utils__WEBPACK_IMPORTED_MODULE_6__[/* dealMoney */ "b"])(orderInfo.actuallyPaid))), __jsx(Sum, null, __jsx("aside", null, Object(_tools_dealKey__WEBPACK_IMPORTED_MODULE_9__[/* ls */ "a"])('获得达人币')), __jsx("main", null, Object(_tools_utils__WEBPACK_IMPORTED_MODULE_6__[/* dealMoney */ "b"])(orderInfo.generateCoin))), __jsx("div", {
    style: {
      height: '96px',
      width: '100%'
    }
...
module.exports = __webpack_require__("DfI7");
...
// EXTERNAL MODULE: ./utils/view/me/orderDetail/orderDetail.tsx
var orderDetail = __webpack_require__("/PM6");
...
// CONCATENATED MODULE: ./utils/view/pay/index.tsx
...
const applicationId = true ? 'sq0idp-IAEwX77Hdunl5dWByHQjIQ' : undefined; // const applicationId = 'sq0idp-IAEwX77Hdunl5dWByHQjIQ'
...
const Pay = () => {
  ...
  const {
    state: stateOD,
    actions: actionsOD
  } = Object(useStore["b" /* useStoreModel */])(orderDetail["b" /* orderDetailModel */]);
  const orderInfo = stateOD.orderInfo || {};
          ...
          */
          cardNonceResponseReceived: function (errors, nonce, cardData) {
            ...
            if (errors) {
              ...
              Object(Message["b" /* showMessage */])('Encountered errors, check browser developer console for more details');
              return;
            ...
            fetch(`/pay/process-payment`, {
              ...
              Object(Message["b" /* showMessage */])('Network error: ' + err);
            }).then(response => {
              if (!response.ok) {
              ...
              return actionsOD.updateOrder({
                id: orderId,
                state: ss_common_enum["g" /* OrderState */].Paid
              });
            }).then(() => {
              Object(Message["b" /* showMessage */])('支付成功');
              router.replace('/cart/result');
            }).catch(err => {
              console.error(err);
              Object(Message["b" /* showMessage */])('Payment failed to complete!\nCheck browser developer console for more details');
            });
          }
        }
      });
  ...
  return __jsx("div", {
    ...
    src: true ? 'https://js.squareup.com/v2/paymentform' : undefined,
    className: "jsx-2628901187"
  })), __jsx(HeaderTitle["a" /* HeaderTitle */], {
    title: '支付',
    backCall: () => {
      router.replace('/home');
      return true;
  ...
  }, "Pay ", Object(utils["b" /* dealMoney */])(orderInfo.actuallyPaid))), __jsx(style_default.a, {
    id: "2628901187"
...
// CONCATENATED MODULE: ./pages/pay/index.tsx

/* harmony default export */ var pay = __webpack_exports__["default"] = (Pay);
